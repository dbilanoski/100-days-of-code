...
### Day 25: February 7th, 2022
Completed second module of the Python course where I worked with control flow logic and iteration.  Today I reviewed useful functions for working with lists and for loops (such as `enumerate()`) and list comprehension way of writing for loops which basicly flattens the for loop. Gotta say it's weird and not that intuitive at first.

```
# Example

my_list = [current for current in "Hello"]

# is same as

my_list = []
for current in "Hello":
...
### Day 54: March 17th, 2022
Another skipped day as yesterday there was simply no time for proper session and later at night I was just too tired. Today continued exploring Python modules, worked with datetime module where I learned how to work with date and time.
...
### Day 60: March 25th, 2022
While it sounds like a plausable thing to do, learning while on business trip with very tight all day schedule is really not. So had a two day break from this is best way to describe it as the things I was able to do were not really something to be seriously counted.
...
* [FreeCodeCamp's Relational Databases](https://www.freecodecamp.org/learn/relational-database/)
